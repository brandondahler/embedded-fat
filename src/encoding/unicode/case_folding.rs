...
#[rustfmt::skip]
static DIFFERENCE_INDICES: [u8; 700] = [
    32,
    32,
    48,
    56,
...
#[rustfmt::skip]
static SMALL_POSITIVE_DIFFERENCES: [u8; 35] = [
    1,
    2,
    8,
    15,
...
const MEDIUM_POSITIVE_DIFFERENCES_START_INDEX: u8 = 97;
#[rustfmt::skip]
    ...
    let mapped_code_unit = match unicode_plane {
        0x00 => {
            translate_code_unit(
                code_unit,
                &RUNS_00,
                RUNS_00_ITEM_OFFSET as usize,
                &ENTRIES_00,
                ENTRIES_00_ITEM_OFFSET as usize
            )
        }
        0x01 => {
            translate_code_unit(
