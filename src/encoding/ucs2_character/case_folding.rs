...
pub fn fold_character(character: u16) -> u16 {
    ...
    match character {
        0x00C0..=0x00D6 => character + 32,
        0x0391..=0x03A1 => character + 32,
        0x0400..=0x040F => character + 80,
        0x0410..=0x042F => character + 32,
        0x0531..=0x0556 => character + 48,
        0x10A0..=0x10C5 => character + 7264,
        0x1C90..=0x1CBA => character - 3008,
        0x2160..=0x216F => character + 16,
        0x24B6..=0x24CF => character + 26,
        0x2C00..=0x2C2F => character + 48,
        0xAB70..=0xABBF => character - 38864,
        0xFF21..=0xFF3A => character + 32,

        // Utilize binary search to find other possible matches
        _ => match LOOKUP.binary_search_by_key(&character, |&(key, _)| key) {
            Ok(index) => LOOKUP[index].1,
            Err(_) => character,
        },
    }
}
...
pub mod tests {
    ...
    #[test]
    fn fold_character_matches_parsed_lookup() {
        for character in 0x0000..=0xFFFF {
            assert_eq!(
